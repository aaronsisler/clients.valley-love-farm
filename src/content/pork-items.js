const porkItems = {
  ...
  porkSausage: [
    ...
    { title: "Smoked Jalape\u00F1o", price: "$11/lb" },
    { title: "Smoked Andouille", price: "$11/lb" },
    { title: "Ground Chorizo", price: "$10/lb" },
    { title: "Ground Country Mild", price: "$10/lb" },
    { title: "Ground Maple Breakfast", price: "$10/lb" },
    { title: "Maple and Sage Breakfast Links", price: "$11/lb" },
